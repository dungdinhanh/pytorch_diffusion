from pytorch_diffusion.test.diffusion_rnn_isolate_iter_sim import DiffusionRNN_IsolateIterSim
import os
...
if __name__ == "__main__":
    ...
    diffusion = DiffusionRNN_IsolateIterSim.from_pretrained(name, log_folder=save_folder, state_path=rnn_state)
